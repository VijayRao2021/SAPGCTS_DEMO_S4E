*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_FAM_FEATURE
*   generation date: 20.09.2021 at 19:11:29
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_FAM_FEATURE      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_FAM_FEATURE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_FAM_FEATURE_EXTRACT
TOTAL = ZV_FAM_FEATURE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_FAM_FEATURE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_FAM_FEATURE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_FAM_FEATURE_EXTRACT
TOTAL = ZV_FAM_FEATURE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_FAM_FEATURE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_FAM_FEATURE'
...
TOTAL = ZV_FAM_FEATURE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_FAM_FEATURE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_FAM_FEATURE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZV_FAM_FEATURE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZV_FAM_FEATURE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_FAM_FEATURE_EXTRACT
TOTAL = ZV_FAM_FEATURE_TOTAL
