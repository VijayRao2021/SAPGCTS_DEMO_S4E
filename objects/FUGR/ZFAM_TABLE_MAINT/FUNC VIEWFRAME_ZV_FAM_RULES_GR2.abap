*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_FAM_RULES_GR2
*   generation date: 20.09.2021 at 19:12:55
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_FAM_RULES_GR2    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_FAM_RULES_GR2'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_FAM_RULES_GR2_EXTRACT
TOTAL = ZV_FAM_RULES_GR2_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_FAM_RULES_GR2'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_FAM_RULES_GR2-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_FAM_RULES_GR2_EXTRACT
TOTAL = ZV_FAM_RULES_GR2_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_FAM_RULES_GR2-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_FAM_RULES_GR2'
...
TOTAL = ZV_FAM_RULES_GR2_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_FAM_RULES_GR2-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_FAM_RULES_GR2-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZV_FAM_RULES_GR2'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZV_FAM_RULES_GR2-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_FAM_RULES_GR2_EXTRACT
TOTAL = ZV_FAM_RULES_GR2_TOTAL
