*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_FAM_RULES_GRP
*   generation date: 20.09.2021 at 19:11:57
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_FAM_RULES_GRP    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_FAM_RULES_GRP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_FAM_RULES_GRP_EXTRACT
TOTAL = ZV_FAM_RULES_GRP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_FAM_RULES_GRP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_FAM_RULES_GRP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_FAM_RULES_GRP_EXTRACT
TOTAL = ZV_FAM_RULES_GRP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_FAM_RULES_GRP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_FAM_RULES_GRP'
...
TOTAL = ZV_FAM_RULES_GRP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_FAM_RULES_GRP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_FAM_RULES_GRP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZV_FAM_RULES_GRP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZV_FAM_RULES_GRP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_FAM_RULES_GRP_EXTRACT
TOTAL = ZV_FAM_RULES_GRP_TOTAL
