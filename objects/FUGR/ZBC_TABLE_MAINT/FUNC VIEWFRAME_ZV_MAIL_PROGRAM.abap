*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_MAIL_PROGRAM
*   generation date: 18.08.2020 at 12:00:51
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_MAIL_PROGRAM     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_MAIL_PROGRAM'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_MAIL_PROGRAM_EXTRACT
TOTAL = ZV_MAIL_PROGRAM_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_MAIL_PROGRAM'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_MAIL_PROGRAM-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_MAIL_PROGRAM_EXTRACT
TOTAL = ZV_MAIL_PROGRAM_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_MAIL_PROGRAM-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_MAIL_PROGRAM'
...
TOTAL = ZV_MAIL_PROGRAM_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_MAIL_PROGRAM-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_MAIL_PROGRAM-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZV_MAIL_PROGRAM'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZV_MAIL_PROGRAM-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_MAIL_PROGRAM_EXTRACT
TOTAL = ZV_MAIL_PROGRAM_TOTAL
