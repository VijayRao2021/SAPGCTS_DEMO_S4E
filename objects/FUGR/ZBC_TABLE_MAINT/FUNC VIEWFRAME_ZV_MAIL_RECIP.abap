*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_MAIL_RECIP
*   generation date: 18.08.2020 at 12:08:17
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_MAIL_RECIP       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_MAIL_RECIP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_MAIL_RECIP_EXTRACT
TOTAL = ZV_MAIL_RECIP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_MAIL_RECIP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_MAIL_RECIP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_MAIL_RECIP_EXTRACT
TOTAL = ZV_MAIL_RECIP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_MAIL_RECIP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_MAIL_RECIP'
...
TOTAL = ZV_MAIL_RECIP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_MAIL_RECIP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_MAIL_RECIP-UPD_FLAG NE SPACE.
