*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_FILE_TRANSFER
*   generation date: 01.09.2021 at 10:17:37
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_FILE_TRANSFER    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_FILE_TRANSFER'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_FILE_TRANSFER_EXTRACT
TOTAL = ZV_FILE_TRANSFER_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_FILE_TRANSFER'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_FILE_TRANSFER-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_FILE_TRANSFER_EXTRACT
TOTAL = ZV_FILE_TRANSFER_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_FILE_TRANSFER-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_FILE_TRANSFER'
...
TOTAL = ZV_FILE_TRANSFER_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_FILE_TRANSFER-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_FILE_TRANSFER-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZV_FILE_TRANSFER'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZV_FILE_TRANSFER-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_FILE_TRANSFER_EXTRACT
TOTAL = ZV_FILE_TRANSFER_TOTAL
