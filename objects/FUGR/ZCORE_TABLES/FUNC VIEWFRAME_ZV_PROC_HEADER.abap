*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_PROC_HEADER
*   generation date: 05.02.2019 at 16:47:40
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_PROC_HEADER      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_PROC_HEADER'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_PROC_HEADER_EXTRACT
TOTAL = ZV_PROC_HEADER_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_PROC_HEADER'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_PROC_HEADER-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_PROC_HEADER_EXTRACT
TOTAL = ZV_PROC_HEADER_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_PROC_HEADER-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_PROC_HEADER'
...
TOTAL = ZV_PROC_HEADER_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_PROC_HEADER-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_PROC_HEADER-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZV_PROC_HEADER'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZV_PROC_HEADER-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_PROC_HEADER_EXTRACT
TOTAL = ZV_PROC_HEADER_TOTAL
