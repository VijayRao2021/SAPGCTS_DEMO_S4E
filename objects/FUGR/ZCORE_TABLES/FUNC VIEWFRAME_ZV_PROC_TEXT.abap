*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_PROC_TEXT
*   generation date: 05.02.2019 at 12:00:53
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_PROC_TEXT        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_PROC_TEXT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_PROC_TEXT_EXTRACT
TOTAL = ZV_PROC_TEXT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_PROC_TEXT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_PROC_TEXT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_PROC_TEXT_EXTRACT
TOTAL = ZV_PROC_TEXT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_PROC_TEXT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_PROC_TEXT'
...
TOTAL = ZV_PROC_TEXT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_PROC_TEXT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_PROC_TEXT-UPD_FLAG NE SPACE.
