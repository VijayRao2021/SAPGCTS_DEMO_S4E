*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZV_FILE_SERVER
*   generation date: 01.09.2021 at 10:20:40
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZV_FILE_SERVER      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZV_FILE_SERVER'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZV_FILE_SERVER_EXTRACT
TOTAL = ZV_FILE_SERVER_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZV_FILE_SERVER'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZV_FILE_SERVER-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_FILE_SERVER_EXTRACT
TOTAL = ZV_FILE_SERVER_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZV_FILE_SERVER-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZV_FILE_SERVER'
...
TOTAL = ZV_FILE_SERVER_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZV_FILE_SERVER-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZV_FILE_SERVER-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZV_FILE_SERVER'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZV_FILE_SERVER-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZV_FILE_SERVER_EXTRACT
TOTAL = ZV_FILE_SERVER_TOTAL
